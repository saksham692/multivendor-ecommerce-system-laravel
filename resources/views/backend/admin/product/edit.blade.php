                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 form-group">
                                    ...
                                    <input class="form-control inputtags" name="tags"
                                           placeholder="Type & Enter" value="{{ $product->tags }}"/>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control @error('current_stock') is-invalid @enderror"
                                           name="current_stock" value="{{ $product->current_stock }}">
                                    @error('current_stock')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-12 form-group">
                                    <div id="attributes-reapeater">
                                        <div data-repeater-list="attributes">
                                            @forelse(json_decode($product->attributes) as $productAttribute)
                                            <div data-repeater-item>
                                                <div class="form-group row mb-0">
                                                    <div class="col-sm-10 col-md-3 form-group">
                                                        ...
                                                        <select class="form-control select2 attribute_name"
                                                            ...
                                                            @foreach($attributes as $attribute)
                                                                <option
                                                                    value="{{ $attribute->name }}" {{ $productAttribute->attribute_name == $attribute->name ? 'selected' : '' }}>
                                                                    {{ $attribute->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                                ...
                                                                <div data-repeater-item>
                                                                    <div class="form-group row mb-0">
                                                                        ...
                                                                        <div class="col-md-5 col-sm-10 form-group">
                                                                            ...
                                                                            <input class="form-control" name="title" value="{{$value->title}}"/>
                                                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 form-group">
                                    ...
                                    <input type="text" class="form-control @error('seo_title') is-invalid @enderror"
                                           name="seo_title" value="{{ $product->seo_title }}">
                                    @error('seo_title')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-sm-12 form-group">
                                    ...
                                    <textarea class="form-control @error('seo_description') is-invalid @enderror"
                                              ...
                                              maxlength="160">{{ $product->seo_description }}</textarea>
                                ...
                                <div class="card-body ">
                                    <div class="" style="height: 300px; overflow: auto">
                                        @foreach ($categories as $category)
                                            @include('backend.admin.product.categoryTree', ['category' => $category, 'productCategoriesIds' => $product->selectedCategoryIds])
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                                    ...
                                    @foreach($collections as $collection)
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="collections[]" class="custom-control-input"
                                                   id="{{ $collection->slug }}"
                                                   value="{{ $collection->id }}" {{ $product->selectedCollectionIds != null && in_array($collection->id, $product->selectedCollectionIds) ? 'checked' : '' }}>
                                    ...
                                    @foreach($labels as $label)
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="labels[]" class="custom-control-input"
                                                   id="{{ $label->slug }}"
                                                   value="{{ $label->id }}" {{ $product->selectedlabelIds != null && in_array($label->id, $product->selectedlabelIds) ? 'checked' : '' }}>
                                            <label class="custom-control-label"

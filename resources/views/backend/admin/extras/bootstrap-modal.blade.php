            ...
            <div class="row">
                    ...
                    <div class="card card-mt">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn btn-danger" data-confirm="Realy?|Do you want to continue?"
                                    data-confirm-yes="alert('Deleted :)');">Delete
                            </button>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Aw, yeah!
                            </button>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="mb-2">Check the <code>modal.js</code> code in the <code>dist/js/page</code> folder

...
class FooterGridTwoController extends Controller
{
    ...
    public function index(FooterGridTwoDataTable $dataTable)
    {
        ...
        return $dataTable->render('backend.admin.footer.footer-grid-two.index', compact('footerTitle'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.backend.footer-grid-two.index')->with('success', 'Created Successfully!');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('backend.admin.footer.footer-grid-two.edit', compact('footer'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.backend.footer-grid-two.index')->with('success', 'Update Successfully!');
    }

...
class FooterSocialController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.backend.footer-socials.index')->with('success', 'Created Successfully!');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('backend.admin.footer.footer-socials.edit', compact('footer'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.backend.footer-socials.index')->with('success', 'Updated Successfully!');
    }

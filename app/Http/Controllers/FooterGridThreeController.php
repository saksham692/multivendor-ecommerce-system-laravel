...
class FooterGridThreeController extends Controller
{
    ...
    public function index(FooterGridThreeDataTable $dataTable)
    {
        ...
        return $dataTable->render('backend.admin.footer.footer-grid-three.index', compact('footerTitle'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.backend.footer-grid-three.index')->with('success', 'Created Successfully!');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('backend.admin.footer.footer-grid-three.edit', compact('footer'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.backend.footer-grid-three.index')->with('success', 'Updated Successfully!');
    }
